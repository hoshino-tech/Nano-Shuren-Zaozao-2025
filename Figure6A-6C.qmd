...
```{r}
#| label: Rename the new cluster
dge_manual = RenameIdents(dge,
                          '0' = 'T cells',
                          '1' = 'Myeloid cells',
                          '2' = 'Epithelial cells',
                          '3' = 'B cells',
                          ...
                          '30' = 'Epithelial cells')
DimPlot(object = dge_manual, 
        pt.size = .1)
```

```{r}
#| label: Save E-MTAB-8107 SCRNA-seq data
saveRDS(dge_manual,'E-MTAB-8107_seurat_dge.rds')
```
